...
#endif
#ifdef SMARTAVAN
//Smartavan Heater Controller (ESP32-WROOM-32D), UART wired to the
//Truma LIN transceiver on TX=16 / RX=17 (same pins as the ESPHome config).
//GPIO2 is the typical onboard LED on generic WROOM32 dev boards - if the
//Smartavan board doesn't break it out or uses it for something else,
//just change this to an unused GPIO or comment out the LED calls in setup()/LedLoop().
#define LED 2
#define LED_ON HIGH
#define LED_OFF LOW
#define TX_PIN 16
...
#endif
#ifndef TX_PIN
#error Please define GOOUUUC3, C3SUPERMINI, WROOM32, SMARTAVAN or your custom LED/TX_PIN/RX_PIN
//#include <stop>
#endif
